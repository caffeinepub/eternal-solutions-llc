...
export class Backend implements backendInterface {
    ...
    async getSubmission(arg0: bigint): Promise<IntakeSubmission> {
        if (this.processError) {
            try {
    ...
    async getSubmissions(): Promise<Array<IntakeSubmission>> {
        if (this.processError) {
            try {
    ...
    async submitIntakeForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string, arg9: string, arg10: string, arg11: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitIntakeForm(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSubmissionStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
